...
int main()
{
	do_extract_image("tep06_image1_joined.bmp", "tes06_00000E48_shadow_jap.bmp", 8, 28, 120, 50);
	do_extract_image("tep06_image1_joined.bmp", "tes06_000027C8_shadow_jap.bmp", 8, 84, 120, 50);
	return 0;
}